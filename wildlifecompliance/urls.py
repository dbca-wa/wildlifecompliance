...
router.register(r'search_offender', offence_api.SearchOffenderViewSet,'search_offender')
router.register(r'offenders', offence_api.OffenderViewSet,'offenders')
...
api_patterns = [re_path(r'^api/my_user_details/$',
                ...
                re_path(r'^api/map_settings$', 
                    main_api.MapSettings.as_view(), 
                    name='map-settings'),
                ...
                re_path(r'^api/geocoding_address_search',
